...
static const AVOption options[] = {
    ...
    { "buffer_size", "BufferSizeInKB represents the maximum possible size of any compressed frames(in bits)", OFFSET(qsv.buffer_size), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, INT_MAX, VE },
